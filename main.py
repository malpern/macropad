...
keyboard.keymap = [
    [KC.AUDIO_MUTE, KC.RGB_TOG, ck['ARCH'], ck['EVERNOTE'], ck['CALANDER'], ck['ZOOM'], ck['DOWNLOADS'], ck['MESSAGES'], ck['WHATSAPP'], ck['FIGMA'], ck['CHATGPT'], ck['TECHMEME'], ck['TWITTER'], ck['YOUTUBE'], KC.KP_PLUS, KC.AUDIO_VOL_DOWN, KC.AUDIO_VOL_UP],
