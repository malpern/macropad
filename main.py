...
encoder_handler.map = [((KC.RGB_HUD, KC.RGB_HUI, [KC.RGB_TOG, KC.LCMD(KC.LCTL(KC.K))]),),]  # Pressing the encoder button will toggle the color AND type Control + Command + K
